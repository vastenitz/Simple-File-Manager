...
import com.example.common.asynctasks.CopyMoveTask
import com.example.common.dialogs.ConfirmationDialog
import com.example.common.dialogs.ExportSettingsDialog
import com.example.common.dialogs.FileConflictDialog
import com.example.common.dialogs.WritePermissionDialog
import com.example.common.extensions.*
import com.example.common.helpers.*
import com.example.common.interfaces.CopyMoveListener
import com.example.common.models.FAQItem
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.example")) {
            callback(true)
            false
