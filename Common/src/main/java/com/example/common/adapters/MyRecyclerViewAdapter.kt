...
import com.example.common.extensions.getAdjustedPrimaryColor
import com.example.common.extensions.getContrastColor
import com.example.common.interfaces.MyActionModeCallback
import com.example.common.views.FastScroller
import com.example.common.views.MyRecyclerView
import java.util.*

abstract class MyRecyclerViewAdapter(val activity: BaseSimpleActivity, val recyclerView: MyRecyclerView,
